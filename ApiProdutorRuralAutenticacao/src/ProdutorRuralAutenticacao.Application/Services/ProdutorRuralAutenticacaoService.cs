...
using ProdutorRuralAutenticacao.Application.Validations.Authenticator;
...
namespace ProdutorRuralAutenticacao.Application.Services
{
    public class ProdutorRuralAutenticacaoService : IProdutorRuralAutenticacaoService
    {
        ...
        public ProdutorRuralAutenticacaoService(IConfiguration configuration, IUserRepository userRepository)
        {
