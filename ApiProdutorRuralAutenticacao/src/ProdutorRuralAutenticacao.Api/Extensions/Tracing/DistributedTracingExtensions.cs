...
namespace ProdutorRuralAutenticacao.Api.Extensions.Tracing
{
    public static class DistributedTracingExtensions
    {
        private static readonly ActivitySource ActivitySource = new("ApiProdutorRuralAutenticacao");

        /// <summary>
        /// Configura OpenTelemetry Distributed Tracing para API Autenticação
        /// </summary>
        ...
        {
            var serviceName = "agro-autenticacao-api";
            ...
            try
            {
                ...
                Console.WriteLine("✅ OpenTelemetry configurado com sucesso para API Autenticação");
            }
            catch (Exception ex)
            {
